...
namespace ColorCode.Formatting
{
    public class HtmlFormatter : IFormatter
    {
                          ...
                          TextWriter textWriter)
        {
            ...
            {
				textWriter.Write(HttpEncoder.HtmlEncode(parsedSourceCode.Substring(offset, styleInsertion.Index - offset)));
            ...
            textWriter.Write(HttpEncoder.HtmlEncode(parsedSourceCode.Substring(offset)));
        }
